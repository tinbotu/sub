...
class SubcultureTitleExtract(Subculture):
    ...
    url_blacklist = ['gyazo.com', '.png', '.jpg', 'slack.com', ]
...
class SubcultureKimoti(Subculture):
    ...
    def response(self):
        otoko_no_bigaku = [
            ...
            # yoidore
            ":yos-1-1::yos-1-2::yos-1-3::yos-1-4:¥n:yos-2-1::yos-2-2::yos-2-3::yos-2-4:¥n:yos-3-1::yos-3-2::yos-3-3::yos-3-4:¥n:yos-4-1::yos-4-2::yos-4-3::yos-4-4:",
        ]
