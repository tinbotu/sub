...
class NotSubculture(object):
    ...
    dic_extend = {
        ...
        '^(?:(今日?|きょう)?外?(暑|寒|あつ|さむ|さみ|あち)い?(ー|のかな|？|\?)|METAR|天気)$': METARSubculture,
        ...
        'オレオ': 'オレオ',
        '(?:社|無職|辞め|仏教|瞑想|無常|数学|OMD|老|帰|[働動行][きい]たくな|出家|転|つま[らん][なん]|休|不景気|舟|眠|だる|熊野|親|介護|[帰か]え?り[たて]|ポキ|気.*?[なね][しー]|終わり|職|怠|引退|オワ)': RetirementLevelUpSubculture,
        ...
        '.+': HitozumaSubculture,
        '..+': KCzumaSubculture,
        '^(?!.*http).*$': NogataSubculture,  # except http
        '.*': AtencionSubculture,  # 同じキーはだめ
        '^\(犬?(逃が?す|捕まえる)\)$': DogeGoAwaySubculture,
        '^\(犬小屋\)$': DogeHouseStatusSubculture,
        '^\(コラッ\)$': DogeDetailStatusSubculture,
        '\(犬\)': ShowDogeSokuSubculture,
        '\(犬転生\)': SelfUpdateSubculture,
        'かわいい': 'ちーちゃんかわいいね/b',
