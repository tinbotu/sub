...
class NotSubculture(object):
    ...
    dic = {'^(Ｓ|ｓ|S|s)(ｕｂ|ub)\s*((Ｃ|ｃ|C|c)(ｕｌｔｕｒｅ|ulture))?$': 'No',
           ...
           u'ストールするぞ(ほんとに)?$': u'はい',
           u'(俺は|おれは)?もう(だめ|ダメ)だ[ー〜]*$': u'どうすればいいんだ/c',
           u'どうすればいいんだ': u'おれはもうだめだ/c',
           ...
           u'オレオ': u'オレオ',
           u'(?:社会|無職|辞め|仏教|瞑想|無常|数学|OMD|老|帰|[働動行][きい]たくな|出家|転職|社畜|つま[らん][なん]|休|不景気|舟|眠|だる|熊野|親|介護|[帰か]え?り[たて]|ポキ|気.*?[なね][しー]|終わり)': SubcultureRetirementLevelUp,
           ...
           u'性欲': u'性欲を持て余す/cC',
           u'(ネムイ|ねむい|ねみー|眠い)': u'http://i.gyazo.com/4f6e3d16fecb81f5c7b5cb371efa9074.jpg/bC',
           u'\(飼い主\)': u'tinbotu',
